...
with open("randomForestOutputs/rf.txt", "w") as f:
    ...
    f.write("--------------------Top 20 Important Features (Gini Importance)--------------------\n")
    used_indices = np.where(importances > 0)[0]
    ...
    f.write(used_importance_df.head(20).to_string())
    f.write("\n")
    f.write("\n")
    f.write("\n")
    used_importance_df=used_importance_df.head(20)
    plt.figure(figsize=(10, 8))
    plt.barh(used_importance_df["feature"], used_importance_df["importance"])
    plt.gca().invert_yaxis()
    plt.xlabel("Importance")
    plt.title("Features Used in Random Forest (Ranked by Gini)")
    plt.tight_layout()
    plt.savefig("randomForestOutputs/used_features_gini.png")
    plt.close()
    ...
    plt.tight_layout()
    plt.savefig("randomForestOutputs/top20_permutation.png")
    plt.close()
...
plt.savefig("randomForestOutputs/confusionMatrix.png", dpi=300, bbox_inches="tight")
plt.close()
...
plt.tight_layout()
plt.savefig("randomForestOutputs/shap_summary.png", dpi=300)
plt.close()
